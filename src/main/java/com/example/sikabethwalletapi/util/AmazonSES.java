...
public class AmazonSES {
    ...
    final String HTMLBODY = "<h1>Please verify your email address</h1>"
            + "<p>Welcome to Sikabeth Wallet. To complete registration process and be able to log in,"
            + " click on the following link: "
            + "<a href='http://localhost:8086/api/v1/user/activate?token=$tokenValue'>"
            + "Final step to complete your registration" + "</a><br/><br/>"
            + "Thank you!";

    // The email body for recipients with non-HTML email clients.
    final String TEXTBODY = "Please verify your email address. "
            + "Welcome to Sikabeth Wallet. To complete registration process and be able to log in,"
            + " open then the following URL in your browser window: "
            + " http://localhost:8086/api/v1/user/activate?token=$tokenValue"
            + " Thank you!";
    ...
    final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
            ...
            + "<a href='http://localhost:8086/api/v1/user/password-reset?token=$tokenValue'>"
    ...
    final String PASSWORD_RESET_TEXTBODY = "A request to reset your password "
            ...
            + " https://http://localhost:8086/api/v1/user/password-reset?token=$tokenValue"
            + " Thank you!";
