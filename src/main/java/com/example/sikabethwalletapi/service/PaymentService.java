...
public interface PaymentService {
    ...
    TransferRecipient setUpTransferRecipient(Principal principal, AccountRequest request);
    TransferResponse setUpTransfer(Principal principal, TransferRequest request);
